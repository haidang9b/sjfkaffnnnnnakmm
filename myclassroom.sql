...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2020 at 04:32 PM
...
--
-- Database: `myclassroom`
--
CREATE DATABASE IF NOT EXISTS `myclassroom` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `myclassroom`;
...
--
-- Table structure for table `account_lophoc`
--
...
--
-- Dumping data for table `account_lophoc`
--
...
--
-- Table structure for table `binhluan_baitap`
--
...
--
-- Dumping data for table `binhluan_baitap`
--
...
--
-- Dumping data for table `loaibaidang`
--
...
--
-- Table structure for table `pending_invited`
--
...
--
-- Dumping data for table `pending_invited`
--
...
--
-- Indexes for table `account_lophoc`
--
...
--
-- Indexes for table `binhluan_baitap`
--
...
--
-- Indexes for table `pending_invited`
--
...
--
-- AUTO_INCREMENT for table `account_lophoc`
--
ALTER TABLE `account_lophoc`
...
--
-- AUTO_INCREMENT for table `binhluan_baitap`
--
ALTER TABLE `binhluan_baitap`
  MODIFY `idbl_bt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `loaibaidang`
--
ALTER TABLE `loaibaidang`
...
--
-- AUTO_INCREMENT for table `pending_invited`
--
ALTER TABLE `pending_invited`
...
--
-- Constraints for table `account_lophoc`
--
ALTER TABLE `account_lophoc`
...
--
-- Constraints for table `binhluan_baitap`
--
ALTER TABLE `binhluan_baitap`
...
--
-- Constraints for table `pending_invited`
--
ALTER TABLE `pending_invited`
