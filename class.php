                    ...
                    if($role){
                        if(!empty($_POST['noidung'])){
                            ...
                            if(!isset($_POST['fileupload']) || empty($_POST['fileupload'])){
                                ...
                                $tenfile = $_POST['fileupload'];
                            }
                            if(update_baidang_by_id($id_edit,$noidung,$tenfile,$code_class,$username)){
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        <div class=\"border rounded mb-3 mt-5 p-3\">
                            ...
                            <div class=\"row-notification\">
                                ...
                                <a href=\"$name_file_upload\">File đính kèm</a>
                                <div>
                                ";
                                if($role){
                                    echo"
                                    <button class=\"btn btn-warning\" onclick=\"showModalEditBaidang($idbaidang,'$noidung')\"  data-toggle=\"modal\" data-target='#suabaidang'>Sửa</button>
                                    <button class=\"btn btn-danger\" id=\"btn-del\" onclick=\"showModalDelBaidang($idbaidang)\"  data-toggle=\"modal\" data-target=\"#confirm-delete-baidang\">Xóa</button>
                                    <h4>Bình Luận</h4>
                                    <br\>
